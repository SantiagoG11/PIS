 ...
 * @author Usuario iTC
 */
public class FrmGeneralUsuario extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        pl.add(lblGolesVisitante, new org.netbeans.lib.awtextra.AbsoluteConstraints(440, 10, 60, 50));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmGeneralUsuario.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmGeneralUsuario().setVisible(true);
            }
        });
    }
