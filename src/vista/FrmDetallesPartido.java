...
public class FrmDetallesPartido extends javax.swing.JFrame {
    ...
    static Equipo e_equipoLocal;
    static Equipo e_equipoVisitante;
    public FrmDetallesPartido() {
        initComponents();
    }

    public void getEquipos(Equipo equipoLocal, Equipo equipoVisitante){
        e_equipoLocal = equipoLocal;
        e_equipoVisitante = equipoVisitante;
    }
